...
class Fox(Animal):
    def __init__(self, species_type, x_radius, y_radius, lifespan, speed, energy, number_of_offspring, world_size,
                 new_births, fox_birth_energy_cost, fox_reproduce_energy_threshold, fox_energy_needed_factor,
                 fox_energy_reduction_factor,energy_gain_factor):
        ...
        self.fox_birth_energy_cost_mean = fox_birth_energy_cost[0]
        self.fox_birth_energy_cost_std = fox_birth_energy_cost[1]
        self.fox_reproduce_energy_threshold = fox_reproduce_energy_threshold
        self.fox_energy_needed_factor = fox_energy_needed_factor
        self.age = 0
        self.is_alive = True
        self.will_move = None
        ...
        self.next_x = None
        self.next_y = None
        self.energy_reduction_factor = fox_energy_reduction_factor
        self.energy_gain_factor = energy_gain_factor

    def energy_needed(self):
        return self.energy_mean * self.fox_energy_needed_factor - self.energy
    ...
    def energy_cost_per_birth(self):
        return np.random.normal(self.fox_birth_energy_cost_mean, self.fox_birth_energy_cost_std)
